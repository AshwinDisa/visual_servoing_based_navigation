...
def get_camera_view(state):
    ...
    pixels_per_meter = 300  # Conversion factor (1 meter = 300 pixels)
    ...
    x_px = int((x / canvas_distance) * pixels_per_meter + canvas_size / 2)
    z_px = int((z / canvas_distance) * pixels_per_meter + canvas_size / 2)
...
if __name__ == "__main__":
    ...
    state = np.array([-1.5, 0.0, 6, 0.0, 0.0, 0.0, 0.0])
